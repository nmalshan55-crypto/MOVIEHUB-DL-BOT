...
• .bs dark knight\n\n📝 _Please provide the Movie or TV Series name!_${DEFAULT_FOOTER}`
    ...
    const API_KEY = "chama_api_b3aa7aedc781b88f642bc05d6b5558a1";
        ...
        const handleSelection = async ({ messages: replyMessages }) => {
            ...
            if (isReplyToSentMsg && sender === replyMek.key.remoteJid) {
                ...
                try {
                    ...
                    const downloadOptionsText = `*❪ DOWNLOAD OPTIONS ❫*\n\n📥 *Select Quality:*\n\n${validDownloads.map((dl, i) => {
                        ...
                        if (isReplyToOptionsMsg && sender === downloadMek.key.remoteJid) {
                            ...
                            try {
                                await socket.sendMessage(sender, {
                                    ...
                                    caption: `*❪ BAISCOPE ❫*\n\n🎬 *${movieInfo.title}*\n📌 *Quality:* _${selectedDownload.quality}_\n📁 *Size:* _${selectedDownload.size || 'N/A'}_${DEFAULT_FOOTER}`
                                }, { quoted: downloadMek });
